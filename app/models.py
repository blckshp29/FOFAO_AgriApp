...
class Field(Base):
    ...
    corn_type = Column(String)
    intended_use = Column(String)
    planting_method = Column(String)
    seed_rate_kg_per_ha = Column(Float)
    seed_bags_count = Column(Float)
    row_spacing_cm = Column(Float)
    hill_spacing_cm = Column(Float)
    target_plant_population = Column(Integer)
    irrigation_source = Column(String)
    drainage_condition = Column(String)
    previous_crop = Column(String)
    basal_fertilizer_type = Column(String)
    basal_fertilizer_rate = Column(Float)
    side_dress_fertilizer_type = Column(String)
    side_dress_fertilizer_rate = Column(Float)
    pest_observations = Column(Text)
    disease_observations = Column(Text)
    infestation_severity = Column(String)
    last_spray_date = Column(DateTime)
    pesticide_used = Column(String)
    moisture_content_at_harvest = Column(Float)
